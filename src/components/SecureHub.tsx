...
interface SecureHubProps { currentUser: User; onBack: () => void; onDeleteAccount: () => void; onOpenDatabase: () => void; }
...
const SecureHub = ({ currentUser, onBack, onDeleteAccount, onOpenDatabase }: SecureHubProps) => {
